...
function bones_scripts_and_styles() {
  if (!is_admin()) {
    ...
    wp_register_script( 'jquery-isotope-min-js', get_stylesheet_directory_uri() . '/library/js/libs/jquery.isotope.min.js', array( 'jquery' ), '', true );
    wp_register_script( 'bones-js', get_stylesheet_directory_uri() . '/library/js/scripts.js', array( 'jquery', 'jquery-isotope-min-js' ), '', true );
    ...
    */
    ...
    $data = array( 'template_directory' => __(get_template_directory_uri()) );
    wp_localize_script( 'bones-js', 'php_data', $data );
